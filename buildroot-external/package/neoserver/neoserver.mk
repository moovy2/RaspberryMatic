...
NEOSERVER_VERSION = 2.20.0
NEOSERVER_SOURCE = neo_server.tar.gz
NEOSERVER_SITE = $(BR2_EXTERNAL_EQ3_PATH)/package/neoserver
NEOSERVER_SITE_METHOD = file
NEOSERVER_LICENSE = BSD-3-Clause
NEOSERVER_LICENSE_FILES = LICENSE

define NEOSERVER_INSTALL_LICENSE_FILE
	cp $(NEOSERVER_PKGDIR)/LICENSE $(@D)/LICENSE
endef
NEOSERVER_POST_EXTRACT_HOOKS += NEOSERVER_INSTALL_LICENSE_FILE
