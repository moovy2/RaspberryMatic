...
CLOUDMATIC_LICENSE_FILES = LICENSE
...
define CLOUDMATIC_INSTALL_LICENSE_FILE
	cp $(CLOUDMATIC_PKGDIR)/LICENSE $(@D)/LICENSE
endef
CLOUDMATIC_POST_EXTRACT_HOOKS += CLOUDMATIC_INSTALL_LICENSE_FILE
